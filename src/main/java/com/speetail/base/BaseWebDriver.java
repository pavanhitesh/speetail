...
import com.speetail.utilities.TestStatus;
...
public class BaseWebDriver {
	...
	Logger logger = LogManager.getLogger(BaseWebDriver.class);
	...
	public WebElement getId(String elementlocator) throws IOException {
		...
		try{
			...
			try{
				...
				SingletonAction.getExtentReport().insertStep(e1.toString(), "", TestStatus.FAIL, "", true);
				throw e;
			}
		}
	...
	public WebElement getLinkText(String elementlocator) throws IOException {
		...
		try{
			...
			try{
				...
				SingletonAction.getExtentReport().insertStep(e1.toString(), "", TestStatus.FAIL, "", false);
				throw e;
			}
		}
